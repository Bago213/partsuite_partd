...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*partutil.Block, error) {
	...
	blocks := make([]*partutil.Block, 0, 256)
	genesis := partutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
