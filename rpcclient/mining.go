...
func (c *Client) SubmitBlockAsync(block *partutil.Block, options *btcjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *partutil.Block, options *btcjson.SubmitBlockOptions) error {
