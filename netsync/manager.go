...
import (
	...
	peerpkg "github.com/particl/partsuite_partd/peer"
...
func (sm *SyncManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*partutil.Block)
		if !ok {
...
// processed.
func (sm *SyncManager) QueueTx(tx *partutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *partutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *partutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
