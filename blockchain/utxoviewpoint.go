...
func (view *UtxoViewpoint) AddTxOuts(tx *partutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *partutil.Tx, blockHeight int32, stxos *[]spentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *partutil.Block, stxos *[]spentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(block *partutil.Block, stxos []spentTxOut) error {
...
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *partutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *partutil.Tx) (*UtxoViewpoint, error) {
	b.chainLock.RLock()
