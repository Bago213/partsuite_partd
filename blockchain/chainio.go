...
// txouts.
func dbFetchSpendJournalEntry(dbTx database.Tx, block *partutil.Block, view *UtxoViewpoint) ([]spentTxOut, error) {
...
func (b *BlockChain) createChainState() error {
	...
	genesisBlock := partutil.NewBlock(b.chainParams.GenesisBlock)
...
func (b *BlockChain) initChainState() error {
	...
	err := b.db.View(func(dbTx database.Tx) error {
		...
		blockWeight := uint64(GetBlockWeight(partutil.NewBlock(&block)))
...
// raw block for the provided node, deserialize it, and return a partutil.Block
// with the height set.
func dbFetchBlockByNode(dbTx database.Tx, node *blockNode) (*partutil.Block, error) {
...
func (b *BlockChain) BlockByHeight(blockHeight int32) (*partutil.Block, error) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHash(hash *chainhash.Hash) (*partutil.Block, error) {
