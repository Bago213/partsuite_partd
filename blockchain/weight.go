...
func GetBlockWeight(blk *partutil.Block) int64 {
...
func GetTransactionWeight(tx *partutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *partutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint,
